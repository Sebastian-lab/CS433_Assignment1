...
public:
    ...
    void setState(ProcState state) {
      ...
      this->state = state; //I am setting the current state of the PCB to the state given in the parameter. 
    }
    ...
    void setPriority(unsigned int priority) {
        // TODO: add your code here
      this->priority = priority; //I am setting the current priority to the priority given in the parameter.
    }
