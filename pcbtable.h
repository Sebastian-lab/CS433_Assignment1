...
private:
  ...
  int size; //created a size so that I can keep track of how many PCB are in the table at all time
  PCB *PCBtable[201]; //created an array for PCB's for my datatype
public:
    /**
